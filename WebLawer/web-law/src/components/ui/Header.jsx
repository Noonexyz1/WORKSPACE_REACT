...
import Logo from '../../assets/logo-dtm-heart.png'
...
export default function Headre() {
  ...
  return (
    <header className="bg-red-500">
        ...
        <nav className="bg-yellow-200 mx-auto flex max-w-7xl items-center justify-between p-5 lg:px-8" aria-label="Global">
